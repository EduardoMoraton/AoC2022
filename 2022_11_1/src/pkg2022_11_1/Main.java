...
public class Main {
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        while (line != null) {
            ...
            m.setTestDiv(Integer.valueOf(line.split(" ")[5]));
        ...
        for (int i = 0; i < 10000; i++) {
            ...
            for (Monkey m2: monkeys) {
                System.out.println(m2.getIteratedItems());
            }
            System.out.println("=========");
        }
        ...
        ArrayList<BigInteger> mBussines = new ArrayList<>();
        
        for (Monkey m2 : monkeys) {
            mBussines.add(new BigInteger(String.valueOf(m2.getIteratedItems())));
        }
        System.out.println(mBussines);
        Collections.sort(mBussines);
        Collections.reverse(mBussines);
        System.out.println(mBussines);
        System.out.println(mBussines.get(0).multiply(mBussines.get(1)));
